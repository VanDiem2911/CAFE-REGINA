...
const MENU_CATEGORIES = [
    ...
    {
        id: 'savory-mouth-pleasure',
        label: 'Savory mouth pleasure',
        items: [
            { name: 'Chapel Hill Shiraz', price: 56, info: 'AU | Bottle' },
            { name: 'Hoegaarden Rose', price: 59, info: 'AR | Bottle' },
            { name: 'Kruger Export', price: 44, info: 'FR | 750 ml' },
...
// ── Page ──────────────────────────────────────────────────────────────────────
export default function SmallHunger({ onNavigate }) {
        ...
        >
            ...
            <div className="max-w-7xl mx-auto px-8 md:px-14 pt-40 pb-20 border-b border-white/5">
                <div className="grid grid-cols-1 lg:grid-cols-[1.8fr_1.5fr]  items-start ">
                    ...
                    {/* Right — description */}
                    <ScrollReveal direction="right" className="lg:-ml-60">
            ...
            <ScrollReveal direction="up" className="py-16 text-center border-b border-white/5">
                <div className="max-w-2xl mx-auto px-8">
                    ...
                    <p className="font-sans text-sm text-[#F3EFE9]/55 font-light leading-relaxed">
                        At Café Regina you will find plenty of delicious options. This way you can satisfy your tasty cravings without it being too heavy on the stomach. For example, you can opt for the farm plank. The board is filled with a selection of artisan cheeses, cold cuts and crispy freshly baked bread.
                    </p>
                </div>
            </ScrollReveal>
